...
def same_tickers(season_tickers):
    ...
    for x in season_tickers[1].ticker:
        print(x)
        print(season_tickers[0][season_tickers[0]['ticker'] == x])
        print(season_tickers[1][season_tickers[1]['ticker'] == x]) 
        print(season_tickers[0][season_tickers[0]['ticker'] == x].head(1))
        print(season_tickers[1][season_tickers[1]['ticker'] == x].head(1))  
        # if x in season_tickers[0].ticker.values and season_tickers[0][season_tickers[0]['ticker'] == x].shares.values == season_tickers[1][season_tickers[1]['ticker'] == x].shares.values:
